			 ...
			 <div class="row justify-content-center">
				<div class="col-12 col-md-10 col-lg-8">
					...
					<div class="input-group-append">
						...
						&nbsp;&nbsp;<a href="#" id="tooltip" rel="tooltip" data-original-title="Add ending point"><i class="fa fa-subway" aria-hidden="true"></i></a>&nbsp;<span class="icon"><span class="fas fa-plus"></span></span>
						</a>             
					</div>
